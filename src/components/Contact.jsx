    ...
    <section className="w-full px-4 md:px-16">
      <div className="bg-gray-100 py-12" data-aos="fade-up">
        ...
        <div className="max-w-7xl mx-auto">
          <p className="text-3xl text-gray-600 underline" data-aos="fade-right">
            Get In Touch With Our Team
          </p>
          <p className="text-sm text-gray-500 mt-5" data-aos="fade-left">
            Stop by at our headquarters, our team is happy to welcome you -
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div data-aos="fade-right">
                  ...
                  <input
                    ...
                    id="first-name"
                    name="first-name"
                    className="w-full px-3 py-2 bg-gray-200 text-black rounded-lg"
                  />
                </div>
          ...
          <div className="space-y-6 text-gray-800" data-aos="fade-up">
            ...
            <p className="leading-relaxed" data-aos="fade-left">
              <strong>DELIMAJAYA Group - Karoseri Delima Jaya</strong>
              <br />
              Since 1975 - No. 1 Special Purpose Vehicle Manufacturer
              <br />
              Bus, Ambulance, and Specialty Truck (Fire, Rescue, Defense,
              Military, Police, Agriculture, Forestry, Mining) Body Builder –
              Karosserie Industry
              <br />
            ...
            <p className="leading-relaxed" data-aos="fade-right">
              <strong>Head Office and Factory - Headquarters HQ:</strong>
              <br />
              Jl. Sholeh Iskandar No. 5, Bogor Utara, Indonesia 18710
              <br />
              Phone: +62 251 8544300 (Hunting), 8854401-404, 8854406, 8854407,
              8860292, 8860804
              <br />
              Fax: +62 251 8800273, 8854405
              <br />
              Email: info@delimajayacarrosserie.com
              <br />
            ...
            <p className="leading-relaxed" data-aos="fade-left">
              ...
              Instagram:{" "}
              <a
                href="https://www.instagram.com/delimajaya/"
              ...
              Linkedin:{" "}
              <a
                href="http://id.linkedin.com/in/delimajaya"
                className="text-blue-600"
              >
                Linkedin
              </a>
              ...
              Facebook:{" "}
              <a
                href="https://id-id.facebook.com/karoseridelimajaya"
                className="text-blue-600"
              >
                Facebook
              </a>
              ...
              Youtube:{" "}
              <a
                href="https://www.youtube.com/c/VinstonWiyanta"
                className="text-blue-600"
              >
                Youtube
              </a>
              ...
              Twitter:{" "}
              <a
                href="https://twitter.com/Delimajaya"
                className="text-blue-600"
              >
                Twitter
              </a>
